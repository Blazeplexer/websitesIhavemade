...
<html>
 ...
 <body background-color:"#152238">
  <br />
	  <a href="Login/logout.php" class = "login">Sign out</a>
  <div class="container">
   <h3 align="center" class="title">Admin Page</h3>
   <br />
   <div align="right">
  ...
  <div class="modal-content">
   <form method="POST" id="edit_image_form">
    <div class="modal-header">
     ...
     <h4 class="modal-title">Edit Comic Details</h4>
    </div>
